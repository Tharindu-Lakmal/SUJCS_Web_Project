...
<body>
  ...
  <p style="color: grey;" ,style="text-align: justify;">Each manuscript should be submitted by e-mail, SUJCS@sab.ac.lk
    attached to a covering letter confirming that it describes original<br>
    research not submitted for publication or already published elsewhere.</p>
  <p style="color: grey;" ,style="text-align: justify;">One author has been designated as the corresponding author with
    contact details:</p>
...
<div class="subManuscript">
  <ul>
    ...
    <li style="color:grey;">Indicate clearly if color should be used for any figures in print Graphical Abstracts /
      Highlights files (where applicable)</li>
...
<div class="subFurtherConsideration">
  <ul>
    ...
    <li style="color:grey;">Permission has been obtained for use of copyrighted material from other sources (including
      the Internet)</li>
    <li style="color:grey;">A competing interests statement is provided, even if the authors have no competing interests
      to declare</li>
...
<div class="subDecleration">
  <p style="color: grey;">When submitting an article, it means that the content has not been published before (except as
    an abstract, lecture, or academic thesis).<br>
    It is also not being considered for publication elsewhere, and all authors and relevant authorities where the work
    was conducted have<br>
    approved its publication.</p>
</div>
...
<div class="subChanges">
  <p style="color: grey;">Authors must carefully consider and finalize the list and order of authors when submitting
    their manuscript. Any changes to the authorship<br>
    list can only be made before the manuscript is accepted, and such changes require approval from the Journal Editor.
    To request a change,<br>
    the corresponding author must provide: (a) a reason for the alteration in the author list, and (b) written
    confirmation (via email or letter) from<br>
    all authors expressing their agreement with the addition, removal, or rearrangement. If an author is being added or
    removed, confirmation <br>
    from that specific author is also necessary.</p>
</div>
...
<div class="subPrivacy">
  <p style="color: grey;">The information provided in this journal, including names and email addresses, will only be
    used for the specific purposes mentioned in<br>
    the journal. It will not be shared with any other party or used for any other reasons.</p>
</div>
...
<div class="subPlagiarism">
  <p style="color: grey;">The Sabaragamuwa University Journal of Computer Science (SUJCS) strictly prohibits plagiarism,
    data or figure manipulation, and the intentional<br>
    dissemination of incorrect information. Additionally, any form of copyright infringement is not allowed. Before
    undergoing peer review,<br>
    all manuscripts will undergo a thorough plagiarism check.<br>
  <p></p>
  <p style="color: grey;">The similarity below 15% is acceptable by the Journal and a similarity of >25% is considered
    as high percentage of plagiarism.</p>
</div>
...
<div class="subAuthor">
  <p style="color: grey;">Authors need to sign up for ORCID and submit these to the journal in the time of submission of
    the manuscript. More information on ORCID<br>
    is available is at https://orcid.org.</p>
</div>
