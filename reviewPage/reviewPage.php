...
<body>
  ...
  <header>
    <h4 style="font-size: 16px;">Review Process</h4>
    ...
    <p style="color: grey;" ,style="text-align: justify;">Manuscripts that successfully clear the initial screening
      ...
      reviewers.</p>
    <h4 style="font-size: 16px;">Copyright</h4>
    ...
    <h4 style="font-size: 16px;">Copyright Notice</h4>
    <p style="color: grey;">Copyright on any research article in the SUJCS is retained by the author(s). Articles in the
      ...
      properly cited.</p>
    <h4 style="font-size: 16px;">Declaration of interest</h4>
    ...
    <h4 style="font-size: 16px;">Submission Guidelines</h4>
    ...
    <h4 style="font-size: 16px;">Preperation</h4>
  ...
  <h4 style="font-size: 16px;"><a style="color: #3F37C9;" href="https://example.com">Organization Of Manuscript </a>
  </h4>
