...
<body>
  ...
  <section class="section">
    ...
    <div class="container-2">
        ...
        <p style="text-align: justify;">Submitted manuscripts undergo an initial assessment, where
        ...
        <p style="text-align: justify;">Manuscripts that successfully clear the initial screening
